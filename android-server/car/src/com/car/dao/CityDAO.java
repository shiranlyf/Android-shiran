...
public class CityDAO extends BaseHibernateDAO {
	...
	public static final String CITY_SORTKEY = "citySortkey";
	...
	public City findById(java.lang.Integer id) {
		...
		try {
			City instance = (City) getSession().get("com.car.entity.City", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(City instance) {
		...
		try {
			List results = getSession().createCriteria("com.car.entity.City")
	...
	public List findByCitySortkey(Object citySortkey) {
		return findByProperty(CITY_SORTKEY, citySortkey);
	}
