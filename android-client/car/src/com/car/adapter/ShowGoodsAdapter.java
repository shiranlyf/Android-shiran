...
public class ShowGoodsAdapter extends SimpleBaseAdapter<Order>{
	
	private ListView  listView;
	private List<Order> data;
	private Context  c;

	public ShowGoodsAdapter(Context c, List<Order> datas, ListView listView) {
		super(c, datas);
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView=layoutInflater.inflate(R.layout.showorderinfo_item, null);
